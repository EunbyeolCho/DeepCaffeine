...
#채송 local_test
train_dir = 'C:/data/cardiovascular_sample/train'
log_dir = 'C:/data/cardiovascular_sample/volume/logs'
test_dir = 'C:/data/cardiovascular_sample/test'
output_dir = 'C:/data/cardiovascular_sample/output'
volume_dir = 'C:/data/cardiovascular_sample/volume'
weight_dir = 'C:/data/cardiovascular_sample/volume/logs' + '_final.hdf5'
